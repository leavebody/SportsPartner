...
public class UserService {
     ...
     */
    public JsonResponse login(String body) throws Exception {
...
//                }
     ...
     * @return JsonResponse to the front-end
     */
    public JsonResponse signup(String body, String type) throws Exception {
        JsonResponse resp = new JsonResponse();
     ...
     */
    public JsonResponse logOut(String userId, String key, String registrationId) throws Exception {
        JsonResponse resp = new JsonResponse();
